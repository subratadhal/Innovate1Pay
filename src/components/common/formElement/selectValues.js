Title
<select lang="blank" title="Title" onchange="showOtherTitle();" name="tbl_ind_reg[title]" id="tbl_ind_reg_title">
...
Education
<select lang="blank2" title="Highest Level of Education" name="tbl_ind_reg[highest_education]" id="tbl_ind_reg_highest_education">

</select>

Country
<select lang="blank5" onchange="getStates();" title="Country of Origin" name="tbl_ind_reg[country_id]" id="tbl_ind_reg_country_id">
<option value="" selected="selected">--Please Select--</option>
...
<option value="632">South Georgia and the South Sandwich Islands</option>
...
<option value="663">United States Minor Outlying Islands</option>
...
<select name="tbl_ind_reg[ffa_association]" id="tbl_ind_reg_ffa_association" title="Freight Forwarding Association Affiliation" lang="blank" onchange="showOtherFfca();"><option value="" selected="selected">--Please Select--</option>
...
Category
<select name="tbl_ind_reg[category]" id="tbl_ind_reg_ffa_category" title="Category" lang="blank"><option value="" selected="selected">--Please Select--</option>
<option value="sff">Staff Freight Forwarder</option>
<option value="eff">Executive Freight Forwarder</option>
</select>

Preferred Validation Centre
<select lang="blank4" title="Preferred Validation Centre" name="tbl_ind_reg[preferred_centre]" id="tbl_ind_reg_preferred_centre">
